...
STRIPE_API_VERSION = getattr(settings, "STRIPE_API_VERSION", "2025-04-30.basil")
...
STRIPE_PAYMENT_SUCCESS_URL = getattr(settings, "STRIPE_PAYMENT_SUCCESS_URL", "/checkout/preview-stripe/{0}/")
STRIPE_PAYMENT_CANCEL_URL = getattr(settings, "STRIPE_PAYMENT_CANCEL_URL", "/checkout/stripe-payment-cancel/{0}/")